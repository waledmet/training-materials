"""
Week 6 Django Settings
Demonstrates: INSTALLED_APPS, MIDDLEWARE (Messages), AUTH settings
"""
...
SECRET_KEY = 'django-insecure-week6-demo-key-do-not-use-in-production'
...
WSGI_APPLICATION = 'week6_blog.wsgi.application'
...
# ─── Authentication Settings (Lesson 10) ─────────────────────────────────────
...
# ─── Messages Framework Tag Mapping (Lesson 12) ──────────────────────────────
